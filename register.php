...
function smtp_mailer($to, $subject, $msg)
{
    ...
    try {
        ...
        $mail->SMTPAuth = true;
        $mail->SMTPSecure = 'tls';
        $mail->Username = "apnaghar024@gmail.com";
        ...
        if (!empty($name) && !empty($email) && !empty($phone) && !empty($pass) && !empty($uimage)) {
            ...
            if ($result) {
                ...
                if ($result === 'Sent') {
                    ...
                    echo "<script>alert('OTP is sent via your email address');</script>";
                    header("Location: otp_verification.php");
                    exit;
                } else {
                    echo "<script>alert('Failed to send email. Please enter valid information.');</script>";
                }
            } else {
