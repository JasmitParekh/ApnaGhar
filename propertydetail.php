                                    ...
                                    <div class="col-sm-8 col-lg-9">
                                        <div class="agent-data text-ordinary mt-sm-20">
                                            ...
                                            <div class="mt-3 text-secondary hover-text-success">
                                                <ul>
                                                    <li class="float-left mr-3"><a href="https://www.facebook.com/share/Z3pLN9jLRyX8E5vz/?mibextid=qi2Omg"><i class="fab fa-facebook-f"></i></a></li>
                                                    <li class="float-left mr-3"><a href="https://x.com/Dhyeychauhan3?t=RUq6nVwm9omdyzCnx4oDvw&s=09"><i class="fab fa-twitter"></i></a></li>
                                                    <li class="float-left mr-3"><a href="dhyeychauhan0@gmail.com"><i class="fas fa-envelope"></i></a></li>
                                                    <li class="float-left mr-3"><a href="https://www.linkedin.com/in/dhyey-chauhan-b3b643255?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app"><i class="fab fa-linkedin-in"></i></a></li>
                                                    <li class="float-left mr-3"><a href="https://www.instagram.com/chauhan.dhyey?igsh=dmhrMmU2cGhjaTJs"><i class="fab fa-instagram"></i></a></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
